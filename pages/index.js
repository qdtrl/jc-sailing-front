  ...
  return (
    <>
      <Head>
        ...
        <meta name='keywords' content='jc sailing, jean-christophe théo, entretien, réparation, antifouling, stratification, nettoyage, carénage, peinture, polyester, primaire époxy, calage de bateau, achat, voilier, moteur, bateau, semi-rigide' />
      </Head>
      <Layout show={false}>
        <main>
          <Jumbotron/>
